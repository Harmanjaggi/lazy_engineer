  ...
  Widget build(BuildContext context) {
    ...
    Future<void> onPress() async {
      if (formGlobalKey.currentState!.validate()) {
        ...
        BlocProvider(
          create: (context) => EditProfileCubit(ProfileRepositoryImpl()),
            ...
            child: Column(
              ...
              children: [
                ...
                CustomTextField.secondary(
                  ...
                  validator: (value) => nullCheckTextValidation(value, designation),
                ),
                const SizedBox(height: 16.0),
                ...
                CustomTextField.secondary(
                  ...
                  hintText: company,
                  validator: (value) => nullCheckTextValidation(value, company),
                ),
                const SizedBox(height: 16.0),
