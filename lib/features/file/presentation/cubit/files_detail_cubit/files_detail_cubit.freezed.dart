...
class _$FilesDetailImpl implements FilesDetail {
  const _$FilesDetailImpl({required this.isFavourite, this.isDownloaded});
  ...
  @override
  String toString() {
    return 'FilesDetailState(isFavourite: $isFavourite, isDownloaded: $isDownloaded)';
  }
...
abstract class FilesDetail implements FilesDetailState {
  const factory FilesDetail(
      {required final bool isFavourite,
      final bool? isDownloaded}) = _$FilesDetailImpl;
