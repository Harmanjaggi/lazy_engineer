              ...
              success: (data) {
                return ListView(
                  ...
                  children: [
                              ...
                              return GestureDetector(
                                ...
                                child: SizedBox(
                                  ...
                                  child: GridCard(
                                    ...
                                    networkImage: workingLink(data.note?[index]?.imageLink),
                                    fixedHeight: true,
                                  ),
                                ),
                              );
                    ...
                    if (data.questionPaper != null && data.questionPaper!.isNotEmpty) ...[
                      Text("Question Paper", style: theme.textTheme.titleLarge),
                      SizedBox(
                        height: 216,
                        child: ListView.separated(
                          shrinkWrap: true,
                            ...
                            if (data.questionPaper?[index] != null) {
                              return SizedBox(
                                ...
                                child: TileView(
                                  ...
                                  image: workingLink(data.questionPaper?[index]?.imageLink),
                                  onPressed: () => context.push(
                                    '${RouteGenerator.questionPaperDescriptionRoute}/${index + 1}',
                                    extra: data.questionPaper?[index],
                                  ),
                                  child: QuestionPaperDataBox(data.questionPaper![index]!),
                                ),
                              );
                            } else {
                              return SizedBox();
                    ...
                    if (data.practicleFile != null && data.practicleFile!.isNotEmpty) ...[
                      Text("Practical File", style: theme.textTheme.titleLarge),
                      SizedBox(
                        height: 216,
                        child: ListView.separated(
                          shrinkWrap: true,
                            ...
                            if (data.practicleFile?[index] != null) {
                              return SizedBox(
                                ...
                                child: TileView(
                                  ...
                                  image: workingLink(data.practicleFile![index]!.imageLink),
                                  child: FileDataBox(
                                    title: data.practicleFile![index]!.title ?? '',
                                    collegeValue: data.practicleFile![index]!.college ?? '',
                                    subjectValue: data.practicleFile![index]!.subject ?? '',
                                    semesterValue: data.practicleFile![index]!.semester ?? '',
                                  ),
                                  onPressed: () => context.push(
                            ...
                            if (jobData != null) {
                              return SizedBox(
                                ...
                                child: TileView(
                                  ...
                                  image: workingLink(data.job![index]!.mediaLink),
                                  fit: BoxFit.contain,
                                  width: 70,
                                  child: JobDataBox(
